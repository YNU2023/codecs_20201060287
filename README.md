...
## 三、写在后面
修改代码过程中，主要工作是将杂乱无章的代码有条理的整理出来，通过删改注释，删除重复代码段，将特定的方法封装成类增加代码的可读性和易用性。
**不可避免的是，由于不了解该科研任务的具体要求，不清晰相应模块的具体调用方式等因素，虽然本着不修改具体代码内容，仅改动项目结构的思想，但仍不可避免的改动了少量代码，可能对实验产生影响，导致代码报错，特在此声明**
